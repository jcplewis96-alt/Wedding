        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ margin: "0 auto 24px", maxWidth: "220px" }}>
                <svg viewBox="0 0 220 340" width="100%" style={{ display: "block" }}>
                  ...
                  <g>
                    {/* Hair */}
                    <path d="M134 35 C130 28 128 22 132 18 C136 14 146 14 150 18 C154 22 152 28 148 35"
                      fill="#4a3828" />
                    {/* Head */}
                    ...
                    {/* Tuxedo jacket */}
                    <path d="M120 78 C118 84 116 95 116 110 L166 110 C166 95 164 84 162 78 C158 74 152 70 141 70 C130 70 124 74 120 78Z"
                      fill="#2a2018"/>
                    {/* Lapels */}
                    ...
                    {/* Trousers */}
                    <path d="M116 110 L112 200 L130 200 L141 150 L152 200 L170 200 L166 110Z"
                      fill="#2a2018"/>
                    {/* Trouser crease */}
                    ...
                    {/* Trouser break */}
                    <path d="M112 290 C112 295 114 300 116 305" stroke="#3a3028" strokeWidth="1" fill="none"/>
                    <path d="M170 290 C170 295 168 300 166 305" stroke="#3a3028" strokeWidth="1" fill="none"/>
                    {/* Shoes */}
            ...
            <div style={{
              ...
              <p style={{
                ...
                Tu presencia es nuestro<br />
                mejor regalo.<br /><br />
                Si deseas tener un gesto adicional,<br />
                encontrarás a continuación<br />
                un código QR y nuestros<br />
