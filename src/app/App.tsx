      ...
      >
        ...
        <div style={{ position: "relative", display: "flex", flexDirection: "column", alignItems: "center" }}>
          ...
          <div style={{ position: "relative", width: "420px", height: "300px" }}>
            ...
            {/* Hand-sketched tree — lush dreamy, constrained to original size */}
            <div style={{
              position: "absolute", left: 0, right: 0, top: "2px",
              display: "flex", justifyContent: "center",
              zIndex: 6, pointerEvents: "none",
            }}>
              <svg viewBox="0 0 120 80" width="90" height="60" style={{ opacity: 0.65 }}>
                <defs>
                  <linearGradient id="trunkG" x1="0" y1="0" x2="1" y2="0">
                    <stop offset="0%"   stopColor="#3d2810" stopOpacity="0.5" />
                    <stop offset="50%"  stopColor="#5a3e20" stopOpacity="1"   />
                    <stop offset="100%" stopColor="#3d2810" stopOpacity="0.4" />
                  </linearGradient>
                </defs>
                <g strokeLinecap="round" strokeLinejoin="round" fill="none">
                  {/* Roots */}
                  <path d="M59 78 C56 75 52 74 48 76"  stroke="#4a3218" strokeWidth="0.9" opacity="0.5" />
                  <path d="M61 78 C64 75 68 74 72 76"  stroke="#4a3218" strokeWidth="0.9" opacity="0.5" />
                  <path d="M60 78 C58 76 57 74 56 76"  stroke="#4a3218" strokeWidth="0.6" opacity="0.4" />
                  <path d="M60 78 C62 76 63 74 64 76"  stroke="#4a3218" strokeWidth="0.6" opacity="0.4" />
                  {/* Trunk */}
                  <path d="M58 78 C57 70 57 62 58 54 C58 48 59 42 60 34" stroke="#5a3e20" strokeWidth="2.8" />
                  <path d="M62 78 C63 70 63 62 62 54 C62 48 61 42 60 34" stroke="#5a3e20" strokeWidth="1.2" opacity="0.35" />
                  <path d="M59 72 C60.5 71 61 70 60 69" stroke="#4a3218" strokeWidth="0.5" opacity="0.5" />
                  <path d="M59 65 C61 64 61.5 63 60 62" stroke="#4a3218" strokeWidth="0.5" opacity="0.5" />
                  <path d="M58 58 C60 57 61 56 59 55"   stroke="#4a3218" strokeWidth="0.5" opacity="0.4" />
                  <path d="M59 50 C61 49 61 48 60 47"   stroke="#4a3218" strokeWidth="0.4" opacity="0.4" />
                  {/* Main branches */}
                  <path d="M58 68 C52 64 44 60 34 56 C26 52 16 50 8 48"  stroke="#5a3e20" strokeWidth="1.8" />
                  <path d="M58 68 C52 65 45 61 35 57"                     stroke="#5a3e20" strokeWidth="0.7" opacity="0.3" />
                  <path d="M62 66 C68 62 76 58 86 54 C94 50 104 48 112 46" stroke="#5a3e20" strokeWidth="1.8" />
                  <path d="M62 66 C68 63 75 59 85 55"                       stroke="#5a3e20" strokeWidth="0.7" opacity="0.3" />
                  <path d="M59 60 C52 55 44 50 34 46 C26 42 18 40 10 36"  stroke="#5a3e20" strokeWidth="1.5" />
                  <path d="M61 58 C68 53 76 48 86 44 C94 40 102 38 110 34" stroke="#5a3e20" strokeWidth="1.5" />
                  <path d="M59 50 C53 45 46 40 38 34 C30 28 22 22 14 16"  stroke="#5a3e20" strokeWidth="1.3" />
                  <path d="M61 48 C67 43 74 38 82 32 C90 26 98 20 106 14" stroke="#5a3e20" strokeWidth="1.3" />
                  <path d="M60 34 C59 26 58 18 59 10 C59 6 60 3 60 0"    stroke="#5a3e20" strokeWidth="1.4" />
                  <path d="M60 40 C54 34 48 28 40 20 C34 14 26 8 18 2"   stroke="#5a3e20" strokeWidth="1.2" />
                  <path d="M60 38 C66 32 72 26 80 18 C86 12 94 6 102 0"  stroke="#5a3e20" strokeWidth="1.2" />
                  {/* Secondary branches */}
                  <path d="M34 56 C28 52 22 48 14 44"  stroke="#5a3e20" strokeWidth="1.0" />
                  <path d="M20 52 C14 48 8 44 4 40"    stroke="#5a3e20" strokeWidth="0.9" />
                  <path d="M8 48 C4 44 2 40 0 36"      stroke="#5a3e20" strokeWidth="0.8" />
                  <path d="M86 54 C92 50 98 46 106 42" stroke="#5a3e20" strokeWidth="1.0" />
                  <path d="M100 48 C106 44 112 40 116 36" stroke="#5a3e20" strokeWidth="0.9" />
                  <path d="M112 46 C116 42 118 38 120 34" stroke="#5a3e20" strokeWidth="0.8" />
                  <path d="M34 46 C28 40 22 34 16 26"  stroke="#5a3e20" strokeWidth="1.0" />
                  <path d="M20 40 C14 34 10 26 6 18"   stroke="#5a3e20" strokeWidth="0.9" />
                  <path d="M10 36 C6 28 4 20 2 12"     stroke="#5a3e20" strokeWidth="0.8" />
                  <path d="M86 44 C92 38 98 32 104 24" stroke="#5a3e20" strokeWidth="1.0" />
                  <path d="M100 38 C106 32 110 24 114 16" stroke="#5a3e20" strokeWidth="0.9" />
                  <path d="M110 34 C114 26 116 18 118 10" stroke="#5a3e20" strokeWidth="0.8" />
                  <path d="M38 34 C32 28 26 20 20 12"  stroke="#5a3e20" strokeWidth="1.0" />
                  <path d="M26 26 C20 20 16 12 12 4"   stroke="#5a3e20" strokeWidth="0.8" />
                  <path d="M14 16 C10 10 8 4 6 0"      stroke="#5a3e20" strokeWidth="0.7" />
                  <path d="M82 32 C88 26 94 18 100 10" stroke="#5a3e20" strokeWidth="1.0" />
                  <path d="M94 24 C100 18 104 10 108 2" stroke="#5a3e20" strokeWidth="0.8" />
                  <path d="M106 14 C110 8 112 2 114 0" stroke="#5a3e20" strokeWidth="0.7" />
                  {/* Fine twigs */}
                  <path d="M0 36 C0 32 0 28 2 24"      stroke="#5a3e20" strokeWidth="0.5" opacity="0.8" />
                  <path d="M4 40 C2 36 0 30 0 24"      stroke="#5a3e20" strokeWidth="0.5" opacity="0.7" />
                  <path d="M2 12 C0 8 0 4 0 0"         stroke="#5a3e20" strokeWidth="0.5" opacity="0.7" />
                  <path d="M6 0 C4 0 2 0 0 0"          stroke="#5a3e20" strokeWidth="0.5" opacity="0.6" />
                  <path d="M12 4 C10 2 8 0 6 0"        stroke="#5a3e20" strokeWidth="0.5" opacity="0.6" />
                  <path d="M18 2 C16 0 14 0 12 0"      stroke="#5a3e20" strokeWidth="0.5" opacity="0.6" />
                  <path d="M120 34 C120 30 120 26 118 22" stroke="#5a3e20" strokeWidth="0.5" opacity="0.8" />
                  <path d="M116 36 C118 32 120 26 120 20" stroke="#5a3e20" strokeWidth="0.5" opacity="0.7" />
                  <path d="M118 10 C120 6 120 2 120 0" stroke="#5a3e20" strokeWidth="0.5" opacity="0.7" />
                  <path d="M114 0 C116 0 118 0 120 0"  stroke="#5a3e20" strokeWidth="0.5" opacity="0.6" />
                  <path d="M108 2 C110 0 112 0 114 0"  stroke="#5a3e20" strokeWidth="0.5" opacity="0.6" />
                  <path d="M102 0 C104 0 106 0 108 0"  stroke="#5a3e20" strokeWidth="0.5" opacity="0.6" />
                  <path d="M59 0 C57 0 55 0 53 0"      stroke="#5a3e20" strokeWidth="0.5" opacity="0.6" />
                  <path d="M59 0 C61 0 63 0 65 0"      stroke="#5a3e20" strokeWidth="0.5" opacity="0.6" />
                  {/* Leaf clusters */}
                  {[
                    {cx:2,  cy:34, rx:5, ry:3, r: -20},
                    {cx:0,  cy:24, rx:4, ry:3, r: -30},
                    {cx:4,  cy:18, rx:4, ry:3, r: -15},
                    {cx:0,  cy:0,  rx:5, ry:3, r: -25},
                    {cx:10, cy:2,  rx:5, ry:3, r: -10},
                    {cx:20, cy:0,  rx:5, ry:3, r: -20},
                    {cx:30, cy:6,  rx:5, ry:3, r: -15},
                    {cx:40, cy:18, rx:5, ry:3, r: -10},
                    {cx:50, cy:8,  rx:5, ry:3, r: -20},
                    {cx:56, cy:0,  rx:5, ry:3, r:   0},
                    {cx:60, cy:0,  rx:4, ry:3, r:   0},
                    {cx:64, cy:0,  rx:5, ry:3, r:   0},
                    {cx:70, cy:8,  rx:5, ry:3, r:  20},
                    {cx:80, cy:18, rx:5, ry:3, r:  10},
                    {cx:90, cy:6,  rx:5, ry:3, r:  15},
                    {cx:100,cy:0,  rx:5, ry:3, r:  20},
                    {cx:110,cy:0,  rx:5, ry:3, r:  20},
                    {cx:118,cy:2,  rx:5, ry:3, r:  10},
                    {cx:120,cy:20, rx:4, ry:3, r:  30},
                    {cx:120,cy:30, rx:5, ry:3, r:  20},
                    {cx:116,cy:14, rx:4, ry:3, r:  25},
                    {cx:8,  cy:44, rx:5, ry:3, r: -15},
                    {cx:14, cy:42, rx:4, ry:3, r: -10},
                  ].map((l, i) => (
                    <ellipse key={i} cx={l.cx} cy={l.cy} rx={l.rx} ry={l.ry}
                      stroke="#5a3e20" strokeWidth="0.65" opacity="0.55"
                      fill="none"
                      transform={`rotate(${l.r}, ${l.cx}, ${l.cy})`}
                    />
                  ))}
                  <ellipse cx="0"   cy="0"  rx="3" ry="2" stroke="#5a3e20" strokeWidth="0.5" opacity="0.4" transform="rotate(-40,0,0)" />
                  <ellipse cx="120" cy="0"  rx="3" ry="2" stroke="#5a3e20" strokeWidth="0.5" opacity="0.4" transform="rotate(40,120,0)" />
                  <ellipse cx="60"  cy="0"  rx="3" ry="2" stroke="#5a3e20" strokeWidth="0.5" opacity="0.4" />
                </g>
              </svg>
            </div>
